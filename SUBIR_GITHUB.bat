...
echo ===============================================
echo   Comunicador 2.5.13 - validar e subir ao GitHub
echo ===============================================
echo.
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%ROOT%tools\Preparar-Release.ps1" -Version "2.5.13.0"
if errorlevel 1 goto :erro
...
if errorlevel 1 (
    set "MENSAGEM=Comunicador 2.5.13 - confirmacao e desempenho"
...
echo   Receptor publicado: 2.5.9
echo   Painel publicado:    2.5.13
echo ===============================================
