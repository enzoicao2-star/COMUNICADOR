...
echo ===============================================
echo   Comunicador 2.4.0 - validar e subir ao GitHub
echo ===============================================
echo.
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%ROOT%tools\Preparar-Release.ps1" -Version "2.4.0.0"
if errorlevel 1 goto :erro
...
if errorlevel 1 (
    set "MENSAGEM=Comunicador 2.4.0 - identidade sincronizada, badges e atualizacao no painel"
...
echo   Receptor publicado: 2.4.0
echo   Painel publicado:    2.4.0
echo ===============================================
