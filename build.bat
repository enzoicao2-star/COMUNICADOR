...
echo ===============================================
echo   Comunicador 2.2.0 - build completo
echo ===============================================
...
echo.
echo [6/8] Compilando o painel 2.2.0 em Release...
...
if not "!VERSAO_GERADA!"=="2.2.0.0" (
    echo ERRO: versao gerada !VERSAO_GERADA!, esperada 2.2.0.0.
    goto :erro
)
