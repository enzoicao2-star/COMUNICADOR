...
echo ===============================================
echo   Comunicador 2.5.2 - build completo
echo ===============================================
...
echo.
echo [6/8] Compilando o painel 2.5.2 em Release...
...
if not "!VERSAO_GERADA!"=="2.5.2.0" (
    echo ERRO: versao gerada !VERSAO_GERADA!, esperada 2.5.2.0.
    goto :erro
)
